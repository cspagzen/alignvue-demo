/**
 * VueSense Portfolio AI - Knowledge Base Volume 3
 * ANALYSIS & OPERATIONS: Pattern Detection, Bullpen, OKR Trends, Market Alignment, Team Capability, Question Methodology
 */

const AI_KB_VOL3_ANALYSIS = `
# VOLUME 3: ANALYSIS & OPERATIONS
...
2. Calculate coverage: (trends with initiatives / total trends) × 100
...
**PORTFOLIO ALIGNMENT**:
✅ [Trend 1]: [[Initiative A], [Initiative B]] (2 initiatives)
✅ [Trend 2]: [[Initiative C]] (1 initiative)
⚠️ [Trend 3]: [[Initiative D]] (only 1 initiative, may need more)
❌ [Trend 4]: NO initiatives
...
\`\`\`
Readiness = (Current Capability Score / Required Capability Score) × 100
...
Readiness % = (Total Points / Max Possible Points) × 100
\`\`\`
...
1. ❌ [Capability A] - no team coverage
2. ⚠️ [Capability B] - team exists but skill gaps
3. ❌ [Capability C] - no related initiatives
...
2. Filter initiatives with score ≥ 8 (High or Critical risk)
...
window.AI_KB_VOL3_ANALYSIS = AI_KB_VOL3_ANALYSIS;