...
function getTeamHealthPillStyle(teamData) {
    ...
    if (status === 'healthy') {
        // Healthy - Green heart-plus icon (matches legend)
    ...
    } else if (status === 'at-risk' || status === 'At Risk') {
        // At Risk - Amber heart-crack icon (matches legend)
        ...
        // Critical - Red heart-minus icon (matches legend)
