...
function getTeamHealthPillStyle(teamData) {
    ...
    // Normalize to handle any case variations
    const normalizedStatus = String(status).trim();
    
    // Check for "Healthy" (capital H)
    if (normalizedStatus === 'Healthy' || normalizedStatus === 'healthy') {
    ...
    // Check for "At Risk" (capital A and R, with space)
    else if (normalizedStatus === 'At Risk' || normalizedStatus === 'at risk' || normalizedStatus === 'at-risk') {
    ...
    // Check for "Critical" (capital C)
    else if (normalizedStatus === 'Critical' || normalizedStatus === 'critical') {
